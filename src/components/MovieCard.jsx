...
function MovieCard({ movie }) {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 1 }}
      layout
      className="card relative w-full md:w-60 h-[410px] md:h-[360px] my-3 mx-4 md:my-5 md:mx-0 cursor-pointer rounded-xl overflow-hidden content-div "
    >
      ...
      >
        {" "}
        {isBookmarked && user ? <AiFillStar /> : <AiOutlineStar />}
      </button>
